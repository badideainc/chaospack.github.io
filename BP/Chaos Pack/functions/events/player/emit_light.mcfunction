...
execute at @a[tag=chaospack:remove_light] run fill ~5 ~4 ~5 ~-5 ~-4 ~-5 air replace light_block_10
...
execute as @a [scores={chaospack:emit_light=1},tag=!chaospack:remove_light] at @s run tag @s add chaospack:remove_light
...
execute as @a [scores={chaospack:emit_light=0}, tag=chaospack:remove_light] at @s run tag @s remove chaospack:remove_light